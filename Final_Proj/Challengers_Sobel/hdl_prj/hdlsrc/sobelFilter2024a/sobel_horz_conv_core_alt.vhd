-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\sobel_horz_conv_core_alt.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: sobel_horz_conv_core_alt
...
ENTITY sobel_horz_conv_core_alt IS
...
END sobel_horz_conv_core_alt;


ARCHITECTURE rtl OF sobel_horz_conv_core_alt IS

  -- Component Declarations
  COMPONENT Subsystem1_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem1_block4
    USE ENTITY work.Subsystem1_block4(rtl);
...
BEGIN
  ...
  u_Subsystem1 : Subsystem1_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
