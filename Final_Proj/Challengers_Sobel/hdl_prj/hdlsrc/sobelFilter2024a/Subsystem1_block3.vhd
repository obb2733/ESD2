-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\Subsystem1_block3.vhd
...
END Subsystem1_block3;


ARCHITECTURE rtl OF Subsystem1_block3 IS

  -- Component Declarations
  COMPONENT slicer_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          channel_in                      :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  FOR ALL : slicer_block
    USE ENTITY work.slicer_block(rtl);
