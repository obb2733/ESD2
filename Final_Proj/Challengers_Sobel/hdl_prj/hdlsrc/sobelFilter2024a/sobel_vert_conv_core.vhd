-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\sobel_vert_conv_core.vhd
...
ENTITY sobel_vert_conv_core IS
...
END sobel_vert_conv_core;


ARCHITECTURE rtl OF sobel_vert_conv_core IS

  -- Component Declarations
  COMPONENT Subsystem1_block5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem1_block5
    USE ENTITY work.Subsystem1_block5(rtl);
...
BEGIN
  ...
  u_Subsystem1 : Subsystem1_block5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
