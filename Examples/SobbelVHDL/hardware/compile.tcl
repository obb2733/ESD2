...
#set_global_assignment -name QIP_FILE ../../rtl/rom_data/rom_data.qip
#set_global_assignment -name QIP_FILE ../../rtl/rom_instructions/rom_instructions.qip
set_global_assignment -name VERILOG_FILE ../../rtl/audio_ip/Altera_UP_Audio_Bit_Counter.v
set_global_assignment -name VERILOG_FILE ../../rtl/audio_ip/Altera_UP_Audio_In_Deserializer.v
set_global_assignment -name VERILOG_FILE ../../rtl/audio_ip/Altera_UP_Audio_Out_Serializer.v
set_global_assignment -name VERILOG_FILE ../../rtl/audio_ip/Altera_UP_Clock_Edge.v
set_global_assignment -name VERILOG_FILE ../../rtl/audio_ip/Altera_UP_I2C.v
set_global_assignment -name VERILOG_FILE ../../rtl/audio_ip/Altera_UP_I2C_AV_Auto_Initialize.v
set_global_assignment -name VERILOG_FILE ../../rtl/audio_ip/Altera_UP_I2C_DC_Auto_Initialize.v
set_global_assignment -name VERILOG_FILE ../../rtl/audio_ip/Altera_UP_I2C_LCM_Auto_Initialize.v
set_global_assignment -name VERILOG_FILE ../../rtl/audio_ip/Altera_UP_Slow_Clock_Generator.v
set_global_assignment -name VERILOG_FILE ../../rtl/audio_ip/Altera_UP_SYNC_FIFO.v
set_global_assignment -name VERILOG_FILE ../../rtl/audio_ip/audio_and_video_config.v
set_global_assignment -name VERILOG_FILE ../../rtl/audio_ip/audio_codec.v
set_global_assignment -name VERILOG_FILE ../../rtl/audio_ip/clock_generator.v
set_global_assignment -name VHDL_FILE ../../rtl/rom_data/rom_data.vhd
set_global_assignment -name VHDL_FILE ../../rtl/rom_instructions/rom_instructions.vhd
set_global_assignment -name VHDL_FILE ../../rtl/rising_edge_synchronizer.vhd
set_global_assignment -name VHDL_FILE ../../rtl/generic_counter.vhd
set_global_assignment -name VHDL_FILE ../../rtl/roomba/edge_detector.vhd
set_global_assignment -name VHDL_FILE ../../rtl/roomba/dj_roomba_3000.vhd
set_global_assignment -name VHDL_FILE ../../rtl/roomba/lowpassfilter_16bit.vhd
set_global_assignment -name VHDL_FILE ../../rtl/roomba/roomba_top.vhd
